        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <div class="text-center mt-5">
                        ...
                        <p class="text-gray-500 mb-0">Ini bukanlah kesalahan, hanya saja anda menemukan lebih dahulu</p>
                        <button class="btn btn-info btn-sm mt-3" onclick="history.back();">&larr; Kembali</button>
